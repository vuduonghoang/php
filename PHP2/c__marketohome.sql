...
--
-- Host: localhost
-- Generation Time: Sep 03, 2010 at 07:49 AM
...
(1, 'honglan@mail.com', '11111111', 'Nguyen Thi Hong Lan', '192 Tran Hung Dao, F1, Q.5', '98989898', '', 'Lan (Den)', 'VIE', 'QNA', 1, 'Tp Ho Chi Minh', '2010-01-28', '2010-01-28'),
(5, 'minhkhai@yahoo.com', '11111111', 'MINH KHAI', '2 Thao Dien, Dist 2.,', '98989898', NULL, 'Khue', 'VIE', 'HCM', 1, 'Ho Chi Minh', '2010-01-28', '2010-01-28'),
(6, 'phuonguyen@hotmail.com', '22222222', 'Phuong Uyen Company', '12 Hong Ha, F. Lien Chieu, Da Nang', '06059686960', '060565656', 'Hong Ha Uyen', 'VIE', 'DAN', 1, 'Tp Da Nang', '2010-01-28', '2010-01-28'),
(2, 'maianh@fpt.com.vn', 'maianh', 'Nguyen Thi Mai Anh', '45 Le Van Sy, F12, Quan 3', '8787878', '3223232', 'Anh', 'VIE', 'CAN', 1, 'Tp Ho Chi Minh', '2010-01-28', '2010-01-28'),
(3, 'duykhanh@yahoo.com', 'duykhanh', 'Pham Huu Duy Khanh', '56 Vuon Lai, F 17, Tan Binh', '090978787', '8732322', 'Khanh', 'VIE', 'DON', 1, 'Tp Ho Chi Minh', '2010-01-28', '2010-01-28'),
(7, 'nvmquang@yahoo.com', 'nvmquang', 'Nguyen Viet Minh Quang', '6 Le Loi, Trung tam Cong nghe phan mem Hue', '054898798', '054687879', 'Quang', 'VIE', 'TTH', 0, 'TT-HUE', '2010-01-28', '2010-01-28'),
(12, 'ha@yahoo.com', '11111111', 'Pham Thi Thu Ha', '102 Le Duan, Dist 2, HCM', '09065485', '8211212', 'Ha Khue', 'VIE', 'ANG', 1, '', '2010-01-28', '2010-01-28'),
(4, 'education@huukhang.com', '', 'HKG Informatics Education Center', '44 Nguyễn Giản Thanh F.15, Q.10, HCMC', '6987980980', '8908908909', '', 'VIE', NULL, 1, '', '2010-01-28', '2010-01-28');
...
INSERT INTO `items` (`ItemId`, `ISBN`, `ItemName`, `Description`, `AuthorId`, `CategoryId`, `ProductionId`, `Pages`, `Price`, `PublishYear`, `Edition`, `LanguageId`, `CustomerTypeId`, `Size`, `Weight`, `Status`, `Relations`, `Filezip`, `ImagePath`, `Activate`, `PostDate`) VALUES
(1, 'INFORMATIC', 'JSP/Servlet/JavaBeans', 'JSP/Servlet/JavaBeans va CSDL SQL Server 7.0, JavaScript', 1, 5, 1, 480, 38000, '07/2000', 1, 'VIE', 1, '320x520', 360, 1, '2,3,21', '', '', 1, '2003-05-19'),
(2, 'INFORMATIC', 'Lập trình chuyên nghiệp SQL Server 2000 Tap 1', 'Lập trình chuyên nghiệp SQL Server 2000, Database Analysic and Design, SQL Language, Database Objects: Tables, Views, Stored Procedure, RUles, Funcitons. Triggers, Transactions, Accounting System Exam', 1, 3, 1, 620, 42000, '05/2001', 1, 'VIE', 1, '320x520', 520, 1, '1,4,5,6,7,8,11,12', '', '', 1, '2003-05-19'),
(3, 'INFORMATIC', 'Lập trình chuyên nghiệp SQL Server 2000 Tap 2', 'Lập trình chuyên nghiệp SQL Server 2000, Database Analysic and Design, Administrator Module, Full Search Text, Query English, Visual Basic and SQL Server , Accounting System Exam', 1, 3, 1, 550, 40000, '01/2002', 1, 'VIE', 1, '320x520', 450, 1, '1,4,5,6,7,8,11,12', '', '', 1, '2003-05-16'),
(5, 'INFORMATIC', 'Lập trình Visual Basic.NET Tập 2', 'Visual Basic.NET, SQL Server 2000, ASP.NET, Web Services', 1, 1, 1, 650, 72000, '07/2002', 1, 'VIE', 1, '320x520', 450, 1, '2,3', '', '', 1, '2003-05-15'),
(6, 'INFORMATIC', 'Lập trình Visual C Sharp .NET Tập 1', 'C Sharp Cơ bản', 1, 1, 1, 620, 65000, '05/2002', 1, 'VIE', 1, '320x520', 300, 1, '', '', '', 1, '2003-05-16'),
(7, 'INFORMATIC', 'Lập trình chuyên nghiệp Visual C Sharp .NET Tập 2', 'C Sharp Cơ bản', 1, 1, 1, 620, 45000, '05/2002', 1, 'VIE', 1, '320x520', 400, 1, '2,3', '', '', 1, '2003-05-14'),
(10, 'INFORMATIC', 'Xây Dựng và Triển Khai Ứng Dụng Thương Mại Điện Tử bằng ASP, SQL Server, Visual Basic, JavaScript.', 'Xây Dựng và Triển Khai Ứng Dụng Thương Mại Điện Tử bằng ASP, SQL Server, Visual Basic, JavaScript, HTML, COM, DCOM, DLL, Mail, Upload, Administration Modules, ...', 1, 5, 1, 1200, 120000, '07/2003', 1, 'VIE', 1, '320x520', 250, 1, '2,3', '', '', 1, '2003-05-19'),
(4, 'INFORMATIC', 'Thiết kế Web bằng PHP and MySQL', 'PHP and MySQL, Oracle, PostgreSQL, MS Access, SQL Server', 1, 5, 1, 900, 90000, '04/2003', 1, 'VIE', 1, '21x25', 600, 1, '', '', '', 1, '2003-05-19'),
(13, 'INFORMATIC', 'Lập trình ứng dụng Microsoft Access 2002 Tập 1', 'Forms, Tables, Queries, Reports, Modules, Visual Basic for Application, ...', 1, 3, 1, 600, 45000, '04/2003', 1, 'VIE', 1, '320x520', 200, 1, '2,3', '', '', 1, '2003-05-19'),
(14, 'INFORMATIC', 'Lập trình ứng dụng Microsoft Access 2002 Tập 2', 'Access, Outlook, SQL Server, Excel, Word, Powerpoint, Windows API, DLL, ...', 1, 3, 1, 600, 50000, '04/2003', 1, 'VIE', 1, '320x520', 250, 1, '2,3', '', '', 1, '2003-05-19'),
(16, 'INFORMATIC', 'Giáo trình lý thuyết và bài tập Delphi', 'Delphi', 2, 1, 1, 800, 80000, '04/2003', 1, 'VIE', 1, '320x520', 420, 1, '', '', '', 1, '2003-05-19'),
(17, 'INFORMATIC', 'Đồ hoạ với Multimedia với PowerPoint 2000', 'Đồ hoạ với Multimedia với PowerPoint 2000', 3, 11, 1, 600, 100000, '01/2003', 1, 'VIE', 1, '320x520', 320, 1, '', '', '', 1, '2003-05-19'),
(18, 'INFORMATIC', 'Sử Dụng & Khai Thác Microsoft Visual FoxPro 6.0', 'Sử Dụng & Khai Thác Microsoft Visual FoxPro ', 4, 3, 1, 605, 60000, '02/2002', 1, 'VIE', 1, '320x520', 350, 1, '', '', '', 1, '2003-05-17'),
(19, 'INFORMATIC', 'Tự Học Lập Trình Chuyên Sâu Visual Basic .NET Trong 21 Ngày', 'Tự Học Lập Trình Chuyên Sâu Visual Basic', 2, 1, 1, 500, 35000, '01/2002', 1, 'VIE', 1, '320x520', 360, 1, '4,5,22', '', '', 1, '2003-05-17'),
(20, 'INFORMATIC', 'Từng bước Lập trình chuyên nghiệp Visual C++ .NET', 'Từng bước Lập trình chuyên nghiệp Visual C++ ', 2, 1, 1, 500, 56000, '02/2003', 1, 'VIE', 1, '320x520', 520, 1, '', '', '', 1, '2003-05-17'),
(21, 'INFORMATIC', 'Cấu Trúc Dữ Liệu Với Java', 'Cấu Trúc Dữ Liệu Với Java', 3, 1, 1, 300, 20000, '01/2003', 1, 'VIE', 1, '320x520', 125, 1, '', '', '', 1, '2003-05-19'),
(22, 'INFORMATIC', 'Từng bước Lập trình với Visual Basic .NET', 'Từng bước Lập trình với Visual Basic .NET', 2, 1, 1, 600, 50000, '12/2003', 1, 'VIE', 1, '320x520', 420, 1, '4,5,19', '', '', 1, '2003-05-16'),
(23, 'INFORMATIC', 'Vẽ Minh Hoạ Vói CorelDRAW 10 - Tập 3', 'Vẽ Minh Hoạ Vói CorelDRAW 10', 4, 11, 1, 700, 70000, '01/2002', 1, 'VIE', 1, '320x520', 410, 1, '', '', '', 1, '2003-05-15'),
(24, 'INFORMATIC', 'Lập trình ASP.NET 3.5', 'Lập trình ASP.NET 3.5', 3, 5, 4, 656, 43000, '02/2004', 1, 'ENG', 2, '21x25', 450, 1, '1,4', 'cbc.zip', '', 1, '2003-05-19');
...
CREATE ALGORITHM=UNDEFINED DEFINER=`root`@`localhost` SQL SECURITY DEFINER VIEW `abc` AS select `productions`.`ProID` AS `ProID`,`productions`.`ProName` AS `ProName` from `productions`;
