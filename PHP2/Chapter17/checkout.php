    ...
    <tr>
      ...
      <td width="548"  valign="top" align="center">
		...
		?>
		  ...
		  {
		  	   $select = "select Name, Address, Phone,";
			   $select.=" Mobile, ProvinceId from Customers";
			   $select.=" where UserId='".$_SESSION["UserId"]."'";
			   $result =null;
				try {  
          ...
          <tr>
            ...
            <form action="register.php?from=cart" method="post" name="formregister" target="_parent">
              ...
              <tr>
				...
				$select = "select ProvinceId, ProvinceName from Provinces";
				$result =null;
				try {  
