 ...
 function CheckLogin()
	   {
		...
		if (document.formlogin.username.value!="" 
		&& !IsEmail(document.formlogin.username.value))
		{
	...
	function CheckRegister()
	   {
		...
		if (document.formregister.address.value=="")
		{
			...
			document.formregister.address.focus();
			return false;
		}
	 ...
	 function CheckOrder()
	   {
		...
		if (document.formregister.fullname1.value=="")
		{
			alert("Please enter your Full name");
			document.formregister.fullname1.focus();
			return false;
		}
		if (document.formregister.address1.value=="")
		{
			alert("Please enter your Address");
			document.formregister.address1.focus();
			return false;
		}
		if (document.formregister.phone1.value=="")
		{
			alert("Please enter your Telephone");
			document.formregister.phone1.focus();
			return false;
		} 	
		if (document.formregister.province1.value=="")
		{
			alert("Please choose your Province");
			document.formregister.province1.focus();
			return false;
		}			
		return true;
    ...
    <tr>
      ...
      <td width="548"  valign="top" align="center">
		...
		?>
          ...
          <form action="login-authentication.php?from=cart" method="post" name="formlogin" target="_parent" onSubmit="return CheckLogin();">
          <tr>
          ...
          <tr>
			...
			{
			?>
            <form action="register.php?from=cart" method="post" name="formregister" target="_parent" onSubmit="return CheckRegister();">
              <tr>
			  ...
			  {
			  ?>
              <form action="order.php" method="post" name="formorder" target="_parent" onSubmit="return CheckOrder();">
               <?php
			  }
			  ?>
              <tr>
