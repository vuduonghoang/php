      ...
      <!--begin body--><br>
	   ...
	   if(isset($_GET["type"]))
	   {
		...
		switch($from)
		{
			...
			case "newaccount":
			 ?>
			Email bạn cung cấp đã tồn tại trong hệ thống MarketoHome.com<br>
            Xin vui lòng nhập Email khác để đăng ký.<br><br>
            Cám ơn bạn đã sử dụng dịch vụ của MarketoHome.com, 
			<br>Nếu đã có tài khoản xin vui lòng nhấn <a href ="login.php">Đăng nhập</a>
            <br><br>Để làm thành viên của MarketoHome.com thì nhấn <a href ="newaccount.php">Tạo tài khoản</a>
			<?php
			break;
		}
	   }
