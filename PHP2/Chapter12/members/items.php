  ...
  <table width="1000" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="548"  valign="top">
		...
		$select = "select count(*) as Numbers from Items";
		...
		if($startpage>1)
		{
			$navigation.="<a href='items.php?currentpage=1'>First</a> &nbsp;" ;
			$navigation.="<a href='items.php?currentpage=".($startpage-1)."'>Previoust</a> &nbsp;" ;
		}
		
		//numeric
		for($i=$startpage; $i<=$endpage ; $i++)	
		{
			$navigation.="<a href='items.php?currentpage=".$i."'>".$i."</a> &nbsp;";		 
		}
		//next
		if($totalPages>$endpage)
		{
			$navigation.="<a href='items.php?currentpage=".($i)."'>Next</a> &nbsp;";
			$navigation.="<a href='items.php?currentpage=".$totalPages."'>Last</a> &nbsp;";
		}
		...
		//echo "<br>startrecord: ". $startRecord;
		//echo "<br>endrecord: ". ($startRecord+ $pageSize);
		
		

        
        $select = "select * from Items limit ".$startRecord.",".$pageSize ;
        //echo $select;
        $result = mysql_query($select, $connect);
        $rows = 0;
        if($result!=null)
            ...
            while($row = mysql_fetch_array($result))
             {
                ...
                echo "<td valign='top'><a href='details.php?itemid=";
                echo $row["ItemId"]. "'>";
                echo $row["ItemName"] ; 
                echo "</a></td></tr>";
