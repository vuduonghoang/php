  ...
  <table width="1000" border="0" cellspacing="0" cellpadding="0">
    ...
    <tr>
      ...
      <td width="548"  valign="top">
		...
		if($startpage>1)
		{
			$navigation.="<a href='list.php?currentpage=1'>First</a> &nbsp;" ;
			$navigation.="<a href='list.php?currentpage=".($startpage-1)."'>Previoust</a> &nbsp;" ;
		}
		
		//numeric
		for($i=$startpage; $i<=$endpage ; $i++)	
		{
			$navigation.="<a href='list.php?currentpage=".$i."'>".$i."</a> &nbsp;";		 
		}
		//next
		if($totalPages>$endpage)
		{
			$navigation.="<a href='list.php?currentpage=".($i)."'>Next</a> &nbsp;";
			$navigation.="<a href='list.php?currentpage=".$totalPages."'>Last</a> &nbsp;";
		}
